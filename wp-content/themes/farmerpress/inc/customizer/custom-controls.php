 ...
 */
class Farmerpress_Dropdown_Taxonomies_Control extends WP_Customize_Control {
...
class Farmerpress_Dropdown_Taxonomy_Control extends WP_Customize_Control {
...
class Farmerpress_Note_Control extends WP_Customize_Control {
...
class Farmerpress_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Farmerpress_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="farmerpress-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 */
class Farmerpress_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class Farmerpress_Customize_Sortable_Control extends WP_Customize_Control {
  ...
  public function render_content() {
    ...
    <ul class="farmerpress-sortable-list">
      ...
      ?>
        ...
        <li>
            <input class="farmerpress-sortable-input sortable-hideme" name="<?php echo esc_attr( $value ); ?> " type="hidden"  value="<?php echo esc_attr( $value ); ?>" />
            <span class ="menu-item-handle sortable-span"> <?php echo esc_attr( $choices[$value] ); ?> </span>
          <i class="dashicons dashicons-menu farmerpress-drag-handle"></i>
        </li>
        ...
        <li class="sortable-hideme">
          <input class="farmerpress-sortable-value" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
        </li>
...
class Farmerpress_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="farmerpress-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'farmerpress' ); ?>" class="farmerpress-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}
...
class Farmerpress_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'column';
...
class Farmerpress_Customize_Column extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @since  1.0.0
 */
class Farmerpress_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
