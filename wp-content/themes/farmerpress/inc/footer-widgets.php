...
class Farmerpress_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'farmerpress';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'farmerpress' ), $i ),
...
// Initialize.
$farmerpress_footer_widgets = new Farmerpress_Footer_Widgets();
